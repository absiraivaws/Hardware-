...
export default function QuotationsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (item: Quotation) => (
        <span className="font-medium text-black">{item.q_no}</span>
      ),
    },
    {
      key: "customer_name",
    ...
    },
    {
      ...
      render: (item: Quotation) => (
        <span
          className={`inline-block rounded-full px-2.5 py-0.5 text-xs font-medium ${statusStyles[item.status] || "bg-gray-100 text-black"}`}
        >
